...
本仓库可选的 shadcn/ui 组件清单（来自 [ui.shadcn.com/docs/components](https://ui.shadcn.com/docs/components)）。需要时用 `npx shadcn@latest add <component-name> --overwrite` 添加或覆盖。
...
未找到所需组件？可查看 [registry directory](https://ui.shadcn.com/docs/directory) 中的社区维护组件。
